...
int main()
{
    ...
    p1.initializeDevelopmentDeck();
    p2.initializeDevelopmentDeck();
    p3.initializeDevelopmentDeck();
    ...
    p1.placeSettlement(gameBoard, 1); // p1 places a settlement in the Forest.
