...
void board::make(){
    ...
    edges_.resize(72);
    hexagons_.resize(19);
    vertexes2_.resize(54);

    
    // Initialize vertices with their respective ids and connections
    
    vertexes_[0] = vertex(0, {resourceTypes::stone}, 0, {&vertexes_[1], &vertexes_[8]},{10});
    vertexes_[1] = vertex(1, {resourceTypes::stone}, 0, {&vertexes_[0], &vertexes_[2]},{10});
    vertexes_[2] = vertex(2, {resourceTypes::stone, resourceTypes::sheep}, 0, {&vertexes_[1], &vertexes_[3], &vertexes_[10]},{10,2});
    vertexes_[3] = vertex(3, {resourceTypes::sheep}, 0, {&vertexes_[2], &vertexes_[4]},{2});
    vertexes_[4] = vertex(4, {resourceTypes::sheep, resourceTypes::wood}, 0, {&vertexes_[3], &vertexes_[5], &vertexes_[12]},{2,9});
    vertexes_[5] = vertex(5, {resourceTypes::wood}, 0, {&vertexes_[4], &vertexes_[6]},{9});
    vertexes_[6] = vertex(6, {resourceTypes::wood}, 0, {&vertexes_[5], &vertexes_[14]},{9});
    vertexes_[7] = vertex(7, {resourceTypes::wheat}, 0, {&vertexes_[8], &vertexes_[17]},{12});
    vertexes_[8] = vertex(8, {resourceTypes::stone, resourceTypes::wheat}, 0, {&vertexes_[0], &vertexes_[7], &vertexes_[9]}, {10,12});
    vertexes_[9] = vertex(9, {resourceTypes::stone, resourceTypes::wheat, resourceTypes::clay}, 0, {&vertexes_[8], &vertexes_[10], &vertexes_[19]}, {10,12,6});
    vertexes_[10] = vertex(10, {resourceTypes::stone, resourceTypes::sheep, resourceTypes::clay}, 0, {&vertexes_[2], &vertexes_[9], &vertexes_[11]}, {10,2,6});
    vertexes_[11] = vertex(11, {resourceTypes::sheep, resourceTypes::clay}, 0, {&vertexes_[10], &vertexes_[12], &vertexes_[21]}, {2,4,6});
    vertexes_[12] = vertex(12, {resourceTypes::wood, resourceTypes::sheep}, 0, {&vertexes_[4], &vertexes_[11], &vertexes_[13]},{2,4,9});
    vertexes_[13] = vertex(13, {resourceTypes::wood, resourceTypes::sheep, resourceTypes::clay}, 0, {&vertexes_[12], &vertexes_[14], &vertexes_[23]},{4,9,10});
    vertexes_[14] = vertex(14, {resourceTypes::wood, resourceTypes::clay}, 0, {&vertexes_[6], &vertexes_[13], &vertexes_[15]},{9,10});
    vertexes_[15] = vertex(15, {resourceTypes::clay}, 0, {&vertexes_[14], &vertexes_[25]}, {10});
    vertexes_[16] = vertex(16, {resourceTypes::wheat}, 0, {&vertexes_[17], &vertexes_[27]},{9});
    vertexes_[17] = vertex(17, {resourceTypes::wheat}, 0, {&vertexes_[7], &vertexes_[16], &vertexes_[18]},{12,9});
    vertexes_[18] = vertex(18, {resourceTypes::wood, resourceTypes::wheat}, 0, {&vertexes_[17], &vertexes_[19], &vertexes_[29]},{9,11,12});
    vertexes_[19] = vertex(19, {resourceTypes::wheat, resourceTypes::wood, resourceTypes::clay}, 0, {&vertexes_[9], &vertexes_[18], &vertexes_[20]}, {12,11,6});
    vertexes_[20] = vertex(20, {resourceTypes::wood, resourceTypes::desert, resourceTypes::clay}, 0, {&vertexes_[19], &vertexes_[21], &vertexes_[31]},{6,11});
    vertexes_[21] = vertex(21, {resourceTypes::desert, resourceTypes::sheep, resourceTypes::clay}, 0, {&vertexes_[11], &vertexes_[20], &vertexes_[22]},{6,4});
    vertexes_[22] = vertex(22, {resourceTypes::desert, resourceTypes::sheep, resourceTypes::wood}, 0, {&vertexes_[21], &vertexes_[23], &vertexes_[33]},{4,3});
    vertexes_[23] = vertex(23, {resourceTypes::wood, resourceTypes::sheep, resourceTypes::clay}, 0, {&vertexes_[13], &vertexes_[22], &vertexes_[24]},{4,3,10});
    vertexes_[24] = vertex(24, {resourceTypes::wood, resourceTypes::stone, resourceTypes::clay}, 0, {&vertexes_[23], &vertexes_[25], &vertexes_[35]}, {10,3,8});
    vertexes_[25] = vertex(25, {resourceTypes::stone, resourceTypes::clay}, 0, {&vertexes_[15], &vertexes_[24], &vertexes_[26]}, {10,8});
    vertexes_[26] = vertex(26, {resourceTypes::stone, resourceTypes::sea}, 0, {&vertexes_[25], &vertexes_[37]}, {8});
    vertexes_[27] = vertex(27, {resourceTypes::wheat, resourceTypes::sea}, 0, {&vertexes_[16], &vertexes_[28]},{9});
    vertexes_[28] = vertex(28, {resourceTypes::sea, resourceTypes::wood, resourceTypes::wheat}, 0, {&vertexes_[27], &vertexes_[29], &vertexes_[38]},{9,8});
    vertexes_[29] = vertex(29, {resourceTypes::wood, resourceTypes::wheat}, 0, {&vertexes_[18], &vertexes_[28], &vertexes_[30]}, {9,8,11});
    vertexes_[30] = vertex(30, {resourceTypes::wood, resourceTypes::stone}, 0, {&vertexes_[29], &vertexes_[31], &vertexes_[40]}, {8,11,3});
    vertexes_[31] = vertex(31, {resourceTypes::wood, resourceTypes::stone}, 0, {&vertexes_[20], &vertexes_[30], &vertexes_[32]}, {11,3});
    vertexes_[32] = vertex(32, {resourceTypes::wheat, resourceTypes::stone}, 0, {&vertexes_[31], &vertexes_[33], &vertexes_[42]},{3,4});
    vertexes_[33] = vertex(33, {resourceTypes::wood, resourceTypes::wheat}, 0, {&vertexes_[22], &vertexes_[32], &vertexes_[34]},{4,3});   
    vertexes_[34] = vertex(34, {resourceTypes::wood, resourceTypes::sheep, resourceTypes::stone}, 0, {&vertexes_[33], &vertexes_[35], &vertexes_[44]},{3,4,5});
    vertexes_[35] = vertex(35, {resourceTypes::wood, resourceTypes::sheep, resourceTypes::stone}, 0, {&vertexes_[24], &vertexes_[34], &vertexes_[36]},{3,5,8});
    vertexes_[36] = vertex(36, {resourceTypes::stone, resourceTypes::sheep, resourceTypes::sea}, 0, {&vertexes_[35], &vertexes_[46], &vertexes_[37]},{5,8});
    vertexes_[37] = vertex(37, {resourceTypes::stone, resourceTypes::sea}, 0, {&vertexes_[26], &vertexes_[36], &vertexes_[38]},{8});
    vertexes_[38] = vertex(38, {resourceTypes::wood, resourceTypes::sea}, 0, {&vertexes_[28], &vertexes_[39], &vertexes_[47]}, {8});
    vertexes_[39] = vertex(39, {resourceTypes::wood, resourceTypes::sea, resourceTypes::clay}, 0, {&vertexes_[38], &vertexes_[40], &vertexes_[47]}, {8,5});
    vertexes_[40] = vertex(40, {resourceTypes::wood, resourceTypes::stone, resourceTypes::clay}, 0, {&vertexes_[30], &vertexes_[39], &vertexes_[41]}, {8,5,3});
    vertexes_[41] = vertex(41, {resourceTypes::stone, resourceTypes::wheat, resourceTypes::clay}, 0, {&vertexes_[40], &vertexes_[42], &vertexes_[49]}, {3,5,6});
    vertexes_[42] = vertex(42, {resourceTypes::wheat, resourceTypes::stone}, 0, {&vertexes_[32], &vertexes_[41], &vertexes_[43]}, {3,6,4});
    vertexes_[43] = vertex(43, {resourceTypes::wheat, resourceTypes::sheep}, 0, {&vertexes_[42], &vertexes_[44], &vertexes_[51]}, {6,4,11});
    vertexes_[44] = vertex(44, {resourceTypes::wheat, resourceTypes::sheep}, 0, {&vertexes_[34], &vertexes_[43], &vertexes_[45]}, {4,5,11});
    vertexes_[45] = vertex(45, {resourceTypes::sea, resourceTypes::sheep}, 0, {&vertexes_[44], &vertexes_[46], &vertexes_[53]}, {5,11});
    vertexes_[46] = vertex(46, {resourceTypes::sea, resourceTypes::sheep}, 0, {&vertexes_[36], &vertexes_[45], &vertexes_[52]},{5});
    vertexes_[47] = vertex(47, {resourceTypes::sea, resourceTypes::clay}, 0, {&vertexes_[38], &vertexes_[48], &vertexes_[39]},{5});
    vertexes_[48] = vertex(48, {resourceTypes::sea, resourceTypes::clay}, 0, {&vertexes_[47], &vertexes_[49], &vertexes_[50]},{5});
    vertexes_[49] = vertex(49, {resourceTypes::sea, resourceTypes::wheat, resourceTypes::clay}, 0, {&vertexes_[48], &vertexes_[50], &vertexes_[41]}, {5,6});
    vertexes_[50] = vertex(50, {resourceTypes::wheat, resourceTypes::sea}, 0, {&vertexes_[49], &vertexes_[51], &vertexes_[48]},{6});
    vertexes_[51] = vertex(51, {resourceTypes::wheat, resourceTypes::sheep, resourceTypes::sea}, 0, {&vertexes_[43], &vertexes_[50], &vertexes_[52]}, {6,11});
    vertexes_[52] = vertex(52, {resourceTypes::sea, resourceTypes::sheep}, 0, {&vertexes_[51], &vertexes_[53], &vertexes_[46]}, {11});
    vertexes_[53] = vertex(53, {resourceTypes::sea, resourceTypes::sheep}, 0, {&vertexes_[45], &vertexes_[52], &vertexes_[46]}, {11});


    for(int i=0; i<54; i++){
        vertexes2_[i]=&vertexes_[i];
    }
...
const std::vector<int>& board::getNeighboringVertices(int id) const {
    (void)id; // Mark id as unused
    static std::vector<int> dummy; // Replace this with actual logic to get neighboring vertices
    return dummy;
}
...
std::vector<hexagon> board::getHexagons() const {
    return hexagons_;
}
std::vector<edge> board::getEdges() const {
    return edges_;
}
std::vector<vertex>board:: getVertexes() const{
    return vertexes_;
}

// std::vector<vertex*> board::getVertexes2() {
//     std::vector<vertex*> vertexes2;
//     for(int i=0; i<54; i++){
//         vertexes2.push_back(&vertexes_[i]);
//     }
//     return vertexes2;
// }
std::vector<vertex*> board::getVertexes2() {
    vertexes2_.clear();
    for(int i=0; i<54; i++){
        vertexes2_.push_back(&vertexes_[i]);
    }
    return vertexes2_;
}
vertex* board::getVertex2(int vertexId){
    return vertexes2_.at(vertexId);
}
