...
public:
    player();
    player(const std::string& name, std::map<resourceTypes, int> playerResources = {}, int victoryPoints = 0, std::vector<vertex*> settlements = {}, std::vector<edge*> roads = {}, int NumOfRoads = 0, int NumOfSettlements = 0,  int NumOfCities = 0, int NumOfKnights = 0);
